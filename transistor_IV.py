...
parser.add_argument("--start-vds", type=float, default=-1.8, help="start vds")
parser.add_argument("--end-vds", type=float, default=-1.8, help="end vds")
parser.add_argument("--step-vds", type=float, default=1, help="step vds")
parser.add_argument("--start-vgs", type=float, default=-1.8, help="start vgs")
parser.add_argument("--end-vgs", type=float, default=1.8, help="end vgs")
parser.add_argument("--step-vgs", type=float, default=100, help="step vgs")
args = parser.parse_args()

# Initialize NI system
nisys = NIRRAM(args.device_no, args.device_no, settings="settings/MPW.json")
